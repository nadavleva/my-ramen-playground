...
EOF
    ...
    echo "  kubectl --context=ramen-dr1 run verify-bucket --image=minio/mc --rm -i --restart=Never -- sh -c \"mc alias set minio http://${HUB_IP}:30900 minioadmin minioadmin && mc ls minio/ramen-metadata/\""
}
